        ...
        <div class="login-form__socials">
          ...
          >
            ...
            >
              <path
                fill="#4285F4"
                d="M22.56 12.25c0-.77-.07-1.5-.2-2.2H12v4.17h5.93a5.07 5.07 0 0 1-2.2 3.32v2.76h3.57c2.09-1.92 3.26-4.75 3.26-8.05Z"
              />
              <path
                fill="#34A853"
                d="M12 23c2.97 0 5.45-.98 7.27-2.65l-3.57-2.76c-.98.67-2.23 1.06-3.7 1.06-2.85 0-5.28-1.92-6.14-4.51H2.2v2.84A11 11 0 0 0 12 23Z"
              />
              <path
                fill="#FBBC05"
                d="M5.86 14.14A6.63 6.63 0 0 1 5.5 12c0-.74.13-1.46.36-2.14V7.02H2.2A11 11 0 0 0 1 12c0 1.78.43 3.46 1.2 4.98l2.86-2.22.8-.62Z"
              />
              <path
                fill="#EA4335"
                d="M12 5.35c1.61 0 3.05.56 4.19 1.63l3.14-3.13C17.45 2.1 14.97 1 12 1A11 11 0 0 0 2.2 7.02l3.66 2.84C6.72 7.27 9.15 5.35 12 5.35Z"
              />
            </svg>
            <span>Google</span>
          </button>
