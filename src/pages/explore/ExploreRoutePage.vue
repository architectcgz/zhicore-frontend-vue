    ...
    <div class="explore-shell">
      <main class="explore-feed" aria-label="内容列表">
        ...
        >
          ...
          <button type="button" class="explore-state__action" @click="retry">
            重试加载
          </button>
        </div>
...
const overviewStats = computed(() => [
  ...
  {
    label: "Categories",
    value: String(discovery.contentCategories.length),
    icon: Tags,
  },
  {
    label: "Contributors",
    value: String(discovery.authors.length),
    icon: Users,
  },
]);
